...
Performance between $ 6.41 $ and $ 45.16 $ was achieved by the self-implemented Emboss-Algorithm. Using 8 threads on the outer with OpenMP used on the outer For-Loop delivers the best performance.
